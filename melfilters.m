function [Filter,MelFrequencyVector,retFilter] = melfilters(N,FrequencyVector,hWindow)
...
for i = 1:N
    ...
    Filter(i,iFilter) = Filter(i,iFilter) / sum(Filter(i,iFilter)) ;
    
    retFilter(i,1) = iFilter(1);
    retFilter(i,2) = iFilter( (length(iFilter)));
end
